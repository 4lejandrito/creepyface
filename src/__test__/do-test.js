...
export default registerCreepyface => {
  ...
  it('looks north-east', () =>
    setsSrc([1, -1], 'http://localhost/northEastUrl'))
  ...
  it('looks south-west', () =>
    setsSrc([-1, 1], 'http://localhost/southWestUrl'))
  it('looks west', () => setsSrc([-1, 0], 'http://localhost/westUrl'))
  it('looks north-west', () =>
    setsSrc([-1, -1], 'http://localhost/northWestUrl'))
  ...
  describe('after unregistering', () => {
    ...
    it('does not look north-east', () =>
      setsSrc([1, -1], 'http://localhost/srcUrl'))
